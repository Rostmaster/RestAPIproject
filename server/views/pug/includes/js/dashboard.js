...
const initAllFlights = async () => {
    let result = await fetch(`${url}/api/services/get_active_flights/`)
...
const initCustomerFlights = async () => {
    ...
    if (userInfo.user.role_id === 3) {
        let result = await fetch(`${url}/api/services/get_customer_flights/`)
        result = await result.json()
        return result
    }

    if (userInfo.user.role_id === 1) {
        let result = await fetch(`${url}/api/services/get_chosen_customer_flights/${activeCustomerId}`)
        result = await result.json()
        return result
    }
}
const initFieldsData = async () => {
    let result = await fetch(`${url}/api/countries/`)
    return await result.json()
}
const initUser = async () => {
    userInfo = await fetch(`${url}/api/services/current_user_info`)
...
const buyTicket = async (event) => {
    ...
    let result = await fetch(`${url}/api/services/buy_ticket`, {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
            'Accept': 'application/json'
    ...
    if (result.ok) window.location = (`${url}/dashboard`);
}
const cancelTicket = async (event) => {
    let result = await fetch(`${url}/api/services/cancel_ticket`, {
        method: 'DELETE',
        headers: {
            'Content-Type': 'application/json',
            'Accept': 'application/json'
...
const updateCustomerInfo = async (event) => {
    ...
    let updateResult = await fetch(`${url}/api/customers/${customerId}`, {
        method: 'PATCH',
        headers: {
            'Content-Type': 'application/json',
            'Accept': 'application/json'
    ...
    if (updateResult.ok) window.location = (`${url}/dashboard`);
...
const updateAirlineInfo = async (event) => {
    ...
    let updateResult = await fetch(`${url}/api/airlines/${airlineId}`, {
        method: 'PATCH',
        headers: {
            'Content-Type': 'application/json',
            'Accept': 'application/json'
...
const deleteFlight = async (event) => {
    let result = await fetch(`${url}/api/services/delete_flight`, {
        method: 'DELETE',
        headers: {
            'Content-Type': 'application/json',
            'Accept': 'application/json'
